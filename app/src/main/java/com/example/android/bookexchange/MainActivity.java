...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String mail = userEmail.getEmail();
        Query query = FirebaseDatabase.getInstance().getReference("users/prakash");
        //Query query = reference.child("users " + mail).orderByChild("from").equalTo("this");
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(DataSnapshot dataSnapshot) {
            ...
            if (dataSnapshot.exists()) {
                String userBranch = dataSnapshot.getValue(UserData.class).getBranch();
                Log.d(TAG, "onDataChange: branch"  + userBranch);
